...
// 操作
public:
	void Save(int,CString strFileName,CString strExtension);
// 重写
public:
...
//	afx_msg void OnMouseHWheel(UINT nFlags, short zDelta, CPoint pt);
	...
	afx_msg void OnCanny();			//canny算法
	afx_msg void OnGaussianfilter();//高斯平滑滤波
	afx_msg void OnOtsu();//大津算法

	afx_msg void OnRButtonDown(UINT nFlags, CPoint point);
	afx_msg int OnCreate(LPCREATESTRUCT lpCreateStruct);
	afx_msg void OnMediacuda();
